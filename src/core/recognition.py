...
def recognition(
    ...
    images = load(db_name)
    cloaked_images = load('CLOAKED')
    masked_images = load('MASKED')
...
def parallel_recognition(
    ...
    X_train, X_test, y_train, y_test = \
        split_data(data=images, test_data=images, templ_to=templ_to)
